...
import 'canvas_clipboard_patrol_test.dart' as canvas_clipboard_patrol_test;
import 'canvas_end_to_end_test.dart' as canvas_end_to_end_test;
import 'canvas_multiselect_group_layers_patrol_test.dart' as canvas_multiselect_group_layers_patrol_test;
import 'canvas_pan_zoom_patrol_test.dart' as canvas_pan_zoom_patrol_test;
import 'canvas_performance_patrol_test.dart' as canvas_performance_patrol_test;
import 'canvas_persistence_patrol_test.dart' as canvas_persistence_patrol_test;
import 'canvas_transform_patrol_test.dart' as canvas_transform_patrol_test;
import 'launch_and_click_test.dart' as launch_and_click_test;
...
Future<void> main() async {
  ...
  group('canvas_clipboard_patrol_test', canvas_clipboard_patrol_test.main);
  group('canvas_end_to_end_test', canvas_end_to_end_test.main);
  group('canvas_multiselect_group_layers_patrol_test', canvas_multiselect_group_layers_patrol_test.main);
  group('canvas_pan_zoom_patrol_test', canvas_pan_zoom_patrol_test.main);
  group('canvas_performance_patrol_test', canvas_performance_patrol_test.main);
  group('canvas_persistence_patrol_test', canvas_persistence_patrol_test.main);
  group('canvas_transform_patrol_test', canvas_transform_patrol_test.main);
  group('launch_and_click_test', launch_and_click_test.main);
